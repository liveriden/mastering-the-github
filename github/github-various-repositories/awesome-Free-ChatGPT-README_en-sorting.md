[@LiLittleCat](https://github.com/LiLittleCat/awesome-free-chatgpt/blob/main/README_en.md)
...
Enter access password 857857 in settings.
        ...
        <tr>
            ...
            <td><details>
<summary>Content is too long, click to expand.</summary>
Free operation steps: Go to API settings and select 'Use custom API endpoint'. Then, enter - https://free.churchless.tech/v1/chat/completions - as the endpoint and leave the API key field blank. 📊 Сейчас год 2023
</details></td>
        </tr>
        <tr>
            <td>52</td>
